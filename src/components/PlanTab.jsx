...
export default function PlanTab({ plan, completions, gymLogs, curWk, setCurWk, tickSession, untickSession, completeWorkout, saveGymLog, user, setPlanModal, weekRatings, rateWeek, history, setHistory }) {
